...
<!-- Typing Animation -->
<p align="center">
    <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Poppins&weight=600&pause=1000&center=true&vCenter=true&width=435&lines=Full+Stack+Web+Developer;React+%7C+Redux.js+%7C+TypeScript+%7C+Sass;Node.js+%7C+Express.js+%7C+MongoDB+%7C+Supabase;+UI%2FUX+Lover+%F0%9F%8E%A8;+Open+Source+Contributor+;%F0%9F%92%AA+Performance+%26+Accessibility+Advocate+;Always+Learning+New+Tech!+;Let's+Build+Something+Awesome+Together!" alt="Typing SVG" /></a>
</p>

<!-- Profile Image -->
<p align="center">
  <img src="images/profileImgSbc.png" alt="Sajib Bhattacharjee" width="260" style="border-radius:50%;" />
</p>
...
I'm Sajib Bhattacharjee, a Full-Stack Web Developer focused on building scalable, high-performance web applications with clean architecture and modern UI/UX.

I work across the full stack using React, TypeScript, Node.js, and Express, along with Supabase and PostgreSQL for backend and database management. I have experience implementing secure authentication systems, RESTful APIs, and state management with Redux.

I specialize in creating responsive, user-centric interfaces while ensuring efficient backend logic and seamless frontend–backend integration. I’m continuously improving my skills and building production-ready applications that solve real-world problems.
...
<details>
  <summary>Show tools & environments</summary>

|                                                               IDE/Editor                                                                |      Browsers      |  API/Testing   |  Deployment  |   Cloud/DB    |                                                    Productivity                                                     |
| :-------------------------------------------------------------------------------------------------------------------------------------: | :----------------: | :------------: | :----------: | :-----------: | :-----------------------------------------------------------------------------------------------------------------: |
|        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" width="32" alt="VSCode"/> VSCode        | 🌐 Chrome DevTools |   🧪 Postman   |  🚀 Netlify  |   🐬 MySQL    | <img src="https://img.shields.io/badge/Notion-000000?logo=notion&logoColor=white" height="24" alt="Notion"/> Notion |
|    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/webstorm/webstorm-original.svg" width="32" alt="WebStorm"/> WebStorm    |     🦊 Firefox     | Thunder Client |    Vercel    | MongoDB Atlas | <img src="https://img.shields.io/badge/Trello-0052CC?logo=trello&logoColor=white" height="24" alt="Trello"/> Trello |
| <img src="https://img.shields.io/badge/CodeSandbox-151515?logo=codesandbox&logoColor=white" height="24" alt="CodeSandbox"/> CodeSandbox |                    |                | GitHub Pages |  PostgreSQL   |   <img src="https://img.shields.io/badge/Slack-4A154B?logo=slack&logoColor=white" height="24" alt="Slack"/> Slack   |
...
- **[Awesome Portfolio](https://github.com/Sajib-Bhattacharjee/sajib-bhattacharjee-portfolio)**  
  ...
  <img src="images/portfolio.png" alt="Portfolio Screenshot" width="400"/>
...
<details>
  <summary>Expand to see my goals</summary>
...
<details>
  <summary>Expand to see education</summary>
...
![GitHub streak stats](https://github-readme-streak-stats.herokuapp.com/?user=sajib-bhattacharjee&theme=radical)
...
**All rights reserved by Sajib Bhattacharjee © 2026**  
